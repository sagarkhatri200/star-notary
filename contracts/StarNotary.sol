...
contract StarNotary is ERC721("StarNotary","STAR") {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender, "Sender is not the owner of token1 or token2");
        ...
        {
            _transfer(ownerOfToken1, ownerOfToken2, _tokenId2);
            _transfer(ownerOfToken2, ownerOfToken1, _tokenId1);
        }
    }
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "Sender is not the owner of this token");
